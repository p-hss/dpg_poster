	...
	\column{.6}
		\block{Cross helicity injection}{
            \begin{minipage}[t]{20cm}
                ...
                for different degrees of alignment $\sigma_{\textsf{\small{C}}} = H_{\textsf{\small{C}}}/H^{\textsf{\small{max}}}_{\textsf{\small{C}}}$.
		...
		\block{Line element statistics}{
            ...
            \begin{minipage}[t]{20cm}
                ...
                After an initial transition phase, where the line elements
                orient themself along the maximum positive strain direction
                the strechting rates settle in a stationary state. The principal 
                strain directions were calculated from the local strain rate
                tensor.
                ...
                The probability functions in the stationary state are shown
                below for different angles between the line elements and the
                principal strain rates as well as vorticity and magnetic fields.
